...
namespace Assets.Scripts.Network
{
    enum EPacketId
    {
        ...
        PKT_C_ChangeWaitingState = 1016,
        PKT_S_ChangeWaitingState = 1017,
        PKT_S_ChangeWaitingStateNotify = 1018,
        PKT_S_ChangeRoomLeaderNotify = 1019,
        PKT_C_EnterGame = 1020,
        PKT_S_EnterGame = 1021,
        PKT_C_EnterGameFinish = 1022,
        PKT_S_EnterGameFinish = 1023,
        PKT_C_LeaveGame = 1024,
        PKT_S_LeaveGame = 1025,
        PKT_C_Move = 1026,
        PKT_S_Move = 1027,
        PKT_S_Spawn = 1028,
        PKT_S_DeSpawn = 1029,
